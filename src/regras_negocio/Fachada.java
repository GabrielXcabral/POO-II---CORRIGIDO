...
public class Fachada {
	...
	public static Time 	criarTime (String nome, String origem) throws Exception {
        ...
        if(origem == null) throw new Exception("Origem não pode ser nulo");
		...
		if (time == null){
            ...
            throw new Exception("Erro ao criar time");
        }
	}
	...
	public static IngressoIndividual criarIngressoIndividual(int id) throws Exception{
		...
		return ingresso;
            ...
            throw new Exception("Erro ao criar ingresso individual");
        }
	}
	...
	public static IngressoGrupo	criarIngressoGrupo(int[] id) throws Exception{
		...
		return ingresso;
            ...
            throw new Exception("Erro ao criar ingresso de grupo");
        }
	}
